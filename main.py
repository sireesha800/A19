...
if __name__ == "__main__":
    ...
    if (args.train == 'cases'):
        os.system(f'python src/train_cases.py --epochs={args.epochs} --batch_size={args.batch_size} --loss={args.loss} --optimizer={args.optimizer}')

    if (args.train == 'deaths'):
        os.system(f'python src/train_deaths.py --epochs={args.epochs} --batch_size={args.batch_size} --loss={args.loss} --optimizer={args.optimizer}')
