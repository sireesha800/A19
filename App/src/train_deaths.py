...
def parse():
    ...
    parser.add_argument('-l', '--loss', type=str,
                        default='huber', required=False)
    parser.add_argument('-op', '--optimizer', type=str,
                        default='adamax', required=False)
...
history = model.fit(xtrain_sc, ytrain_sc, epochs=args.epochs,
                    batch_size=args.batch_size, verbose=1, validation_split=0.1)
