...
fn_date = str(
    input("Enter the date to be predicted in the format DD-MM-YYYY: "))
...
print(
    f"The estimated number of cases in day {date2.strftime('%d-%m-%Y')} is {'{:,}'.format(int(res1))}")
print(
    f"The estimated number of deaths in day {date2.strftime('%d-%m-%Y')} is {'{:,}'.format(int(res2))}")
